...
using SchoolManagement.Areas.Identity.Pages.Account;
...
namespace SchoolManagement.Areas.Identity.Pages.Account
{
    public class NextStepModel : PageModel
    {
        ...
        {
            returnUrl ??= Url.Content("~/");
            _logger.LogInformation($"Input.City: {Input.FirstName}, {Input.LastName}");
            ...
            // Log the City value
            _logger.LogInformation($"Input.FirstName: {Input.FirstName}, {Input.LastName}");
            ...
            if (Input1 != null && !string.IsNullOrEmpty(Input1.Email))
            {
                ...
                ModelState.Remove("Input.EmailId");
                ...
                if (ModelState.IsValid)
                {
                    ...
                    ApplicationUser.EmailId = Input1.Email;
                    ApplicationUser.Age = Input.Age;
